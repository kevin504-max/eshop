...
INSERT INTO `products` (`id`, `title`, `slug`, `category_id`, `description`, `price`, `discountPercentage`, `rating`, `stock`, `brand`, `thumbnail`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(36, 'iPhone 9', 'iphone_9', 5, 'An apple mobile which is nothing like apple', 549.00, 12.96, 4.69, 94, 'Apple', '1687446330.jpg', '2023-06-22 18:05:30', '2023-06-22 18:17:10', NULL),
	(37, 'iPhone X', 'iphone_x', 1, 'SIM-Free, Model A19211 6.5-inch Super Retina HD display with OLED technology A12 Bionic chip with ...', 899.00, 17.94, 4.44, 31, 'Apple', '1687446332.jpg', '2023-06-22 18:05:32', '2023-06-22 18:05:32', NULL),
	(38, 'Samsung Universe 9', 'samsung_universe_9', 1, 'Samsung\'s new variant which goes beyond Galaxy to the Universe', 1249.00, 15.46, 4.09, 36, 'Samsung', '1687446333.jpg', '2023-06-22 18:05:33', '2023-06-22 18:05:33', NULL),
	(39, 'OPPOF19', 'oppof19', 1, 'OPPO F19 is officially announced on April 2021.', 280.00, 17.91, 4.30, 123, 'OPPO', '1687446334.jpg', '2023-06-22 18:05:34', '2023-06-22 18:05:34', NULL),
	(40, 'Huawei P30', 'huawei_p30', 3, 'Huawei’s re-badged P30 Pro New Edition was officially unveiled yesterday in Germany and now the device has made its way to the UK.', 499.00, 10.58, 4.09, 31, 'Huawei', '1687446335.jpg', '2023-06-22 18:05:35', '2023-06-22 18:05:35', NULL),
	...
	(42, 'Samsung Galaxy Book', 'samsung_galaxy_book', 1, 'Samsung Galaxy Book S (2020) Laptop With Intel Lakefield Chip, 8GB of RAM Launched', 1499.00, 4.15, 4.25, 50, 'Samsung', '1687446338.jpg', '2023-06-22 18:05:38', '2023-06-22 18:05:38', NULL),
	(43, 'Microsoft Surface Laptop 4', 'microsoft_surface_laptop_4', 1, 'Style and speed. Stand out on HD video calls backed by Studio Mics. Capture ideas on the vibrant touchscreen.', 1499.00, 10.23, 4.43, 68, 'Microsoft Surface', '1687446339.jpg', '2023-06-22 18:05:39', '2023-06-22 18:05:39', NULL),
	(44, 'Infinix INBOOK', 'infinix_inbook', 1, 'Infinix Inbook X1 Ci3 10th 8GB 256GB 14 Win10 Grey – 1 Year Warranty', 1099.00, 11.83, 4.54, 96, 'Infinix', '1687446340.jpg', '2023-06-22 18:05:40', '2023-06-22 18:05:40', NULL),
	...
	(46, 'perfume Oil', 'perfume_oil', 1, 'Mega Discount, Impression of Acqua Di Gio by GiorgioArmani concentrated attar perfume Oil', 13.00, 8.40, 4.26, 65, 'Impression of Acqua Di Gio', '1687446343.jpg', '2023-06-22 18:05:43', '2023-06-22 18:05:43', NULL),
	(47, 'Brown Perfume', 'brown_perfume', 1, 'Royal_Mirage Sport Brown Perfume for Men & Women - 120ml', 40.00, 15.66, 4.00, 52, 'Royal_Mirage', '1687446344.jpg', '2023-06-22 18:05:44', '2023-06-22 18:05:44', NULL),
	...
	(49, 'Non-Alcoholic Concentrated Perfume Oil', 'non_alcoholic_concentrated_perfume_oil', 1, 'Original Al Munakh® by Mahal Al Musk | Our Impression of Climate | 6ml Non-Alcoholic Concentrated Perfume Oil', 120.00, 15.60, 4.21, 114, 'Al Munakh', '1687446347.jpg', '2023-06-22 18:05:47', '2023-06-22 18:05:47', NULL),
	(50, 'Eau De Perfume Spray', 'eau_de_perfume_spray', 1, 'Genuine  Al-Rehab spray perfume from UAE/Saudi Arabia/Yemen High Quality', 30.00, 10.99, 4.70, 105, 'Lord - Al-Rehab', '1687446348.jpg', '2023-06-22 18:05:48', '2023-06-22 18:05:48', NULL),
	(51, 'Hyaluronic Acid Serum', 'hyaluronic_acid_serum', 1, 'L\'OrÃ©al Paris introduces Hyaluron Expert Replumping Serum formulated with 1.5% Hyaluronic Acid', 19.00, 13.31, 4.83, 110, 'L\'Oreal Paris', '1687446349.jpg', '2023-06-22 18:05:49', '2023-06-22 18:05:49', NULL),
	(52, 'Tree Oil 30ml', 'tree_oil_30ml', 1, 'Tea tree oil contains a number of compounds, including terpinen-4-ol, that have been shown to kill certain bacteria,', 12.00, 4.09, 4.52, 78, 'Hemani Tea', '1687446351.jpg', '2023-06-22 18:05:51', '2023-06-22 18:05:51', NULL),
	(53, 'Oil Free Moisturizer 100ml', 'oil_free_moisturizer_100ml', 1, 'Dermive Oil Free Moisturizer with SPF 20 is specifically formulated with ceramides, hyaluronic acid & sunscreen.', 40.00, 13.10, 4.56, 88, 'Dermive', '1687446352.jpg', '2023-06-22 18:05:52', '2023-06-22 18:05:52', NULL),
	(54, 'Skin Beauty Serum.', 'skin_beauty_serum', 1, 'Product name: rorec collagen hyaluronic acid white face serum riceNet weight: 15 m', 46.00, 10.68, 4.42, 54, 'ROREC White Rice', '1687446353.jpg', '2023-06-22 18:05:53', '2023-06-22 18:05:53', NULL),
	(55, 'Freckle Treatment Cream- 15gm', 'freckle_treatment_cream_15gm', 1, 'Fair & Clear is Pakistan\'s only pure Freckle cream which helpsfade Freckles, Darkspots and pigments. Mercury level is 0%, so there are no side effects.', 70.00, 16.99, 4.06, 140, 'Fair & Clear', '1687446354.jpg', '2023-06-22 18:05:54', '2023-06-22 18:05:54', NULL),
	...
	(57, 'Elbow Macaroni - 400 gm', 'elbow_macaroni_400_gm', 1, 'Product details of Bake Parlor Big Elbow Macaroni - 400 gm', 14.00, 15.58, 4.57, 146, 'Bake Parlor Big', '1687446357.jpg', '2023-06-22 18:05:57', '2023-06-22 18:05:57', NULL),
	(58, 'Orange Essence Food Flavou', 'orange_essence_food_flavou', 1, 'Specifications of Orange Essence Food Flavour For Cakes and Baking Food Item', 14.00, 8.04, 4.85, 26, 'Baking Food Items', '1687446358.jpg', '2023-06-22 18:05:58', '2023-06-22 18:05:58', NULL),
	(59, 'cereals muesli fruit nuts', 'cereals_muesli_fruit_nuts', 1, 'original fauji cereal muesli 250gm box pack original fauji cereals muesli fruit nuts flakes breakfast cereal break fast faujicereals cerels cerel foji fouji', 46.00, 16.80, 4.94, 113, 'fauji', '1687446360.jpg', '2023-06-22 18:06:00', '2023-06-22 18:06:00', NULL),
	(60, 'Gulab Powder 50 Gram', 'gulab_powder_50_gram', 1, 'Dry Rose Flower Powder Gulab Powder 50 Gram • Treats Wounds', 70.00, 13.58, 4.87, 47, 'Dry Rose', '1687446361.jpg', '2023-06-22 18:06:01', '2023-06-22 18:06:01', NULL),
	(61, 'Plant Hanger For Home', 'plant_hanger_for_home', 1, 'Boho Decor Plant Hanger For Home Wall Decoration Macrame Wall Hanging Shelf', 41.00, 17.86, 4.08, 131, 'Boho Decor', '1687446362.jpg', '2023-06-22 18:06:02', '2023-06-22 18:06:02', NULL),
	...
	(63, '3D Embellishment Art Lamp', '3d_embellishment_art_lamp', 1, '3D led lamp sticker Wall sticker 3d wall art light on/off button  cell operated (included)', 20.00, 16.49, 4.82, 54, 'LED Lights', '1687446365.jpg', '2023-06-22 18:06:05', '2023-06-22 18:06:05', NULL),
	...
	(65, 'Key Holder', 'key_holder', 1, 'Attractive DesignMetallic materialFour key hooksReliable & DurablePremium Quality', 30.00, 2.92, 4.92, 54, 'Golden', '1687446368.jpg', '2023-06-22 18:06:08', '2023-06-22 18:06:08', NULL);
