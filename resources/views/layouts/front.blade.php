...
<head>
    ...
    {{-- Owl Carousel --}}
    <link rel="stylesheet" href="{{ asset('frontend/css/owl.carousel.min.css', true) }}">
    <link rel="stylesheet" href="{{ asset('frontend/css/owl.theme.default.min.css', true) }}">
...
<body>
    ...
    <script src="{{ asset('frontend/js/owl.carousel.min.js', true) }}"></script>
    ...
    <script src="{{ asset('frontend/js/custom.js', true) }}"></script>
    <script src="{{ asset('frontend/js/checkout.js', true) }}"></script>
